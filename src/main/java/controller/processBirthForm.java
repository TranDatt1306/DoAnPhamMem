...
/**
 * Servlet implementation class processBirthForm
 */
@WebServlet("/processBirthForm")
public class processBirthForm extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public processBirthForm() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String SQL = "INSERT INTO DangKyKhaiSinh ("
	            + "maDangKyKhaiSinh,idHo, hoTen, ngaySinh, gioiTinh, danToc, quocTich, noiSinh, queQuan, noiCuTru, tenCha, cccdCha, tenMe, cccdMe, trangThaiDuyet"
	            + ") VALUES (default,?,?,?,?,?,?,?,?,?,?,?,?,?,1)";
