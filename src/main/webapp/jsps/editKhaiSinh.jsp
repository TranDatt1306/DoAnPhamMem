                ...
                <div class="row">
                    ...
                    <div class="col l-7 m-8">
 				 		<div class="form_khaisinh " id="dkkhaisinh">
                            <h2>Cập nhật khai sinh</h2>
                           <!-- Biểu mẫu khai sinh -->
							<form action="UpdateKhaiSinh" id="form_mau_khaisinh" method="post">
							    ...
							    <div class="list_form_info">
							        <div class="form_info_nam">
							            ...
							            <input type="radio" name="gender" id="nam" value="N" <c:if test="${birthRegistration.getGioiTinh() == 'N'}">checked</c:if>>
							        </div>
							        <div class="form_info_nu">
							            <label for="nu">Nữ</label>
							            <input type="radio" name="gender" id="nu" value="A" <c:if test="${birthRegistration.getGioiTinh() == 'A'}">checked</c:if>>
							        </div>
							    </div>
							    ...
							    <div class="list_form_info">
							        <div class="form_info_date">
							            ...
							            <input type="date" name="ngaysinh" value="${birthRegistration.getNgaySinh()}"> <!-- Sửa lại từ datetime -->
							        </div>
                                ...
                                <div class="list_form_info">
                                 ...
                                 <div class="list_form_info">
                                    <div class="form_info_quequan">
                                        <label for="cutru">Cư trú:</label>
                                        <input type="text" name="cutru" value= "${birthRegistration.getNoiCuTru()}">
                                    </div>
                                </div>
							    <!-- Đảm bảo các phần tử khác sử dụng tên thuộc tính chính xác -->
							    
							    <div class="list_form_info">
							        <div class="form_info_hotenme">
							            <label for="hotenme">Họ tên mẹ:</label>
							            <input type="text" name="hotenme" value="${birthRegistration.getTenMe()}">
							        </div>
							        <div class="form_info_cmndme">
							            <label for="cmndme">CMND/CCCD:</label>
							            <input type="text" name="cmndme" value="${birthRegistration.getCccdMe()}">
							        </div>
							    </div>
							
							    <!-- Tương tự cho thông tin cha và các phần tử khác -->
							    <div class="list_form_info">
							        <div class="form_info_hotencha">
							            <label for="hotencha">Họ tên cha:</label>
							            <input type="text" name="hotencha" value="${birthRegistration.getTenCha()}">
							        </div>
							        <div class="form_info_cmndcha">
							            <label for="cmndcha">CMND/CCCD:</label>
							            <input type="text" name="cmndcha" value="${birthRegistration.getCccdCha()}">
							        </div>
							    </div>
							    
							    <button type="submit" class="send_form_employ_accept">Lưu</button>
							</form>
