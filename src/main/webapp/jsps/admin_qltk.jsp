...
<body>
    ...
    <div class="app">
        ...
        <div class="grid wide">
            <div class="header">
                ...
                <div class="nav">
                    <div class="nav_item"><a id="first_navi" href="admin_page.html">Trang Chủ</a></div>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="user_afterlogin_content">
                            <div class="user_afterlogin">
                                <div class="hello_user"><i class="fa-solid fa-user" id="hello_user_icon"></i>
                                    ...
                                    <h3>Admin <span id="hello_user_name">Nguyễn Mạnh Dũng</span></h3>
                                </div>
                                <ul class="user_afterlogin_listinfo">
                                    <li><a href="#">danh sách biểu mẫu</a></li>
                                    <li><a href="AdminAcc">quản lý tài khoản</a></li>
                                    <li><a href="AdminStatis">thống kê</a></li>
                    ...
                    <div class="col l-12 m-12">
                        <div class="manage_account_box">
                            <div class="row">
                                <div class="col l-12 m-12">
                                    <div class="cruid_account">
                                        <div class="cruid_srearch_box">
                                            <form action="Search" method="post">
                                                <input type="search" placeholder="Tìm kiếm tài khoản..."
                                                    id="cruid_srearch_box--input" name="querysearch">
                                                <input type="submit" value="Tìm kiếm" id="cruid_srearch_box--button">
                                            </form>
                                        </div>
                                        <div class="cruid_dstk">
                                            <div class="cruid_dstk_head">
                                                <p id="title_dstk">Danh sách tài khoản</p>
                                                <div class="cruid_button">
                                                    <button id="butto_backup">Hoàn tác</button>
                                                    <button id="button_add">Thêm mới</button>
                                                </div>
                                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="check_active">
                                                                    <input type="checkbox" class="btn_check_active">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="function_manage">
                                                                    <button class="btn_edit"><i
                                                                            class="fa-solid fa-pen-to-square"></i></button>
                                                                    <button class="btn_delete"><i
    ...
    <!--form edit item-->
    <div class="edit_info close">
        <div class="edit_info_box">
            <h1 class="edit_title">Chỉnh sửa thông tin</h1>
            <form action="" class="box_input_edit">
                ...
                <div class="edit_input">
                    <label for="">Ngày cấp (dd/MM/yyyy)</label>
                    <input type="text" placeholder="Ngày cấp">
                </div>
                <div class="edit_input_status">
                    <label for="">Hoạt động</label>
                    <input type="checkbox" class="btn_check_active_edit">
                </div>
                <input type="submit" class="btn_edit_save" value="Lưu"></input>
                <!--thong bao trang thai dang nhap-->
                <div class="applogin_announce">
                    <p id="applogin_announce--content">Không thành công !!!</p>
                </div>
    ...
    <!--form add item-->
    <div class="add_info close">
        <div class="edit_info_box">
            <h1 class="edit_title">Thêm Mới Tài khoản</h1>
            <form action="" class="box_input_edit">
                ...
                <div class="add_input_status">
                    <label for="">Hoạt động</label>
                    <input type="checkbox" class="btn_check_active_edit">
                </div>
                <input type="submit" class="btn_edit_add" value="Thêm"></input>
                <!--thong bao trang thai dang nhap-->
                <div class="applogin_announce">
                    <p id="applogin_announce--content">Không thành công !!!</p>
                </div>
